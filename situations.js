const gameSituations = {
    ...
    first_clean_start: {
        ...
        choices: [
            ...
            {
                text: "Искать честных рекламодателей с помощью объявления на столбе 'Ищем рекламодателей. Приносим удачу. Дорого'",
                effects: {
                    trust: 5,
                    budget: 5000,
                    readers: 500,
    ...
    comment_section: {
        id: "comment_section",
        text: "В комментариях к политической статье разгорелась настоящая война. Модераторы работают круглосуточно, но не справляются",
        choices: [
            {
    ...
    staff_exodus: {
        ...
        choices: [
            {
                text: "Ответить им эпической рэп-баттл офертой с повышением зарплаты",
                effects: {
                    budget: -30000,
                    staffMorale: 25,
                    readers: 2000,
    ...
    ai_writer: {
        ...
        choices: [
            ...
            {
                text: "Уволить весь отдел и нанять армию нейросетей",
                effects: {
                    budget: 20000,
                    readers: 5000,
                    staffMorale: -20,
    ...
    office_plant: {
        ...
        choices: [
            {
                text: "Создать Instagram для растения и брендировать его",
                effects: {
                    budget: -2000,
                    readers: 3000,
                    staffMorale: 15,
